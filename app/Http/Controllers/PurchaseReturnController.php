...
class PurchaseReturnController extends AppBaseController
{
    ...
    public function create($customerId = null)
    {
        ...
        // Fetch purchase items for dropdown
    ...
    //     $invoice = PurchaseInvoice::with((['customer', 'customer.supplierCountry', 'salesItems','salesItems.service', 'terms']))->where('estimate_number', $invoice)->first();
    ...
    public function getInvoice($invoice)
    {
        $invoice = PurchaseInvoice::with([
            ...
            'salesItems.service',
            'terms'
        ])->where('estimate_number', $invoice)->first();
    ...
    public function edit(PurchaseReturn $return)
    {
        ...
        $estimate = $return;
        return view('purchase-returns.edit', compact('customer', 'estimate', 'data', 'services', 'estimate', 'addresses', 'terms', 'categories', 'groups', 'purchaseCategories', 'subcategories', 'units', 'purchaseItems', 'branches', 'usersBranches', 'paymentModes'));
    }
