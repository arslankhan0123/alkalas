...
class InvoiceController extends AppBaseController
{
    ...
    public function create($customerId = null)
    {
        ...
        $services = $data['items'];
        // Get purchase items instead of services
        $purchaseItems = PurchaseItem::with(['category', 'brand', 'unit'])->get();
        $categories = PurchaseCategory::pluck('name', 'id')->toArray();
        ...
        return view('invoices.create', compact('data', 'isRound', 'customerId', 'settings', 'purchaseItems', 'terms', 'nextNumber', 'categories', 'customers', 'usersBranches', 'branches', 'purchaseItems', 'projects', 'services', 'productUnits'));
    }
    ...
    //     $query = PurchaseItem::with(['category', 'unit'])
    //         ->select('id', 'code', 'name', 'price', 'cost_price', 'description', 'purchase_category_id', 'qty_current', 'stock');

    //     // If you want to filter by branch in the future
    //     // if ($branchId) {
    ...
    //             'category_id' => $item->purchase_category_id,
    //             'stock' => $item->qty_current ?? $item->stock ?? 0,
    ...
    public function getPurchaseItems(Request $request)
    {
        ...
        $purchaseItems = PurchaseItem::select('id', 'name', 'code', 'price', 'stock')
        ...
        return response()->json(['results' => $purchaseItems]);
    }
    // public function create($customerId = null)
    // {
    //     $data = $this->invoiceRepository->getSyncList();
