...
class EstimateController extends AppBaseController
{
    ...
    //         })
    //         ->toArray();
    //     return view('estimates.create', compact('data', 'services', 'isRound', 'customerId', 'settings', 'nextNumber', 'terms', 'categories', 'customers', 'usersBranches', 'purchaseItems'));
    // }
    public function create($customerId = null)
    {
        $data = $this->estimateRepository->getSyncList();
        ...
        $purchaseItems = PurchaseItem::select('id', 'code', 'name', 'price', 'stock', 'unit_id')
            ->with('productUnit:id,title') // Eager load product unit
            ->get()
            ->map(function ($item) {
                return [
                    'id' => $item->id,
        ...
        return view('estimates.create', compact('data', 'services', 'isRound', 'customerId', 'settings', 'nextNumber', 'terms', 'categories', 'customers', 'usersBranches', 'purchaseItems', 'productUnits'));
    }
    ...
    public function edit(Estimate $estimate)
    {
        ...
        $purchaseItems = PurchaseItem::select('id', 'code', 'name', 'price', 'stock', 'unit_id')
            ...
            ->toArray();
        return view('estimates.edit', compact('data', 'isRound', 'services', 'estimate', 'addresses', 'terms', 'categories', 'customers', 'usersBranches', 'purchaseItems','productUnits'));
    }
