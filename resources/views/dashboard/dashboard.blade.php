                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="width: 100px;text-align:center">
                                                            {{ $sheet->employee->iqama_no ?? 'N/A' }}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div style="width: 130px;text-align:left;">
                                                            {{ $sheet->employee->name ?? 'N/A' }}
                                                        </div>
                                                    </td>
                                                    <td class="text-right">{{ isset($sheet->basic_salary) ? number_format($sheet->basic_salary, 2) : 'N/A' }}</td>
                                                    <td class="text-right">{{ isset($sheet->total_bonus) ? number_format($sheet->total_bonus, 2) : 'N/A' }}</td>
                                                    <td class="text-right">{{ isset($sheet->total_overtimes) ? number_format($sheet->total_overtimes, 2) : 'N/A' }}</td>
                                                    <td class="text-right">{{ isset($sheet->total_allowances) ? number_format($sheet->total_allowances, 2) : 'N/A' }}</td>
                                                    <td class="text-right">{{ isset($sheet->gross_salary) ? number_format($sheet->gross_salary, 2) : 'N/A' }}</td>
                                                    <td class="text-right">{{ isset($sheet->salary_advance) ? number_format($sheet->salary_advance, 2) : 'N/A' }}</td>
                                                    <td class="text-right">{{ isset($sheet->loan) ? number_format($sheet->loan, 2) : 'N/A' }}</td>
                                                    <td class="text-right">{{ isset($sheet->hourly_deduction) ? number_format($sheet->hourly_deduction, 2) : 'N/A' }}</td>
                                                    <td class="text-right">{{ isset($sheet->total_deduction) ? number_format($sheet->total_deduction, 2) : 'N/A' }}</td>
                                                    <td class="text-right">{{ isset($sheet->net_salary) ? number_format($sheet->net_salary, 2) : 'N/A' }}</td>
                                                    <td style="white-space: nowrap;" class="text-right">
                                                        <button onclick="printItem({{ $sheet->id }})" class="btn btn-info btn-sm">
                                                            <i class="fas fa-print"></i>
                                                        </button>
                                                        <button onclick="downloadItem({{ $sheet->id }})" class="btn btn-success btn-sm ms-2">
