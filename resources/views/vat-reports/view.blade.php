        ...
        $(document).ready(function() {
            ...
            $("#btnExportPdf").click(function() {
                ...
                $(".markItemCheckbox:checked").each(function() {
                    ...
                    } else if (nameAttr.startsWith('purchaseIvoice[')) {
                        selectedPurchaseInvoices.push($(this).val()); // Collect return IDs
                    } else if (nameAttr.startsWith('purchaseReturn[')) {
                        selectedPurchaseReturns.push($(this).val()); // Collect return IDs
                    }
                });
