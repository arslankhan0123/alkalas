                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-2">
                            ...
                            <input type="month" id="globalSearch" class="form-control"
                                ...
                                placeholder=" __('messages.customer.select_month')" max="{{ \Carbon\Carbon::now()->format('Y-m') }}" > 
                        </div>
            ...
            function populateEmployees(departmentId, designationId) {
                ...
                $.each(allEmployees, function(index, employee) {
                    if (
                        ...
                        employeeSelect.append(new Option(employee.name + ' (Iqama No: ' + employee.iqama_no + ')', employee.id));
                    }
                });
            ...
            function updateTotals() {
                ...
                $('#manageAttendancesTable tbody tr').each(function() {
                    ...
                    $(this).find('td.day-input input').each(function() {
                        ...
                        if(date < join_date) {
                            if (dayName !== 'Fri') { totalAbsentHours += 8; } 
                            return true;
                        }
